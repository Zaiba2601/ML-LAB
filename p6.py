...
print("#########################################################################################################")
print("\n \n ---Dropping null values (dropping whole row wherever null value is there --- \n")
...
print("\n \n ---Median value for total_bedrooms column is",median)
...
print("\n \n ---Categories of the encoders are : ",ordinal_encoder.categories_)
